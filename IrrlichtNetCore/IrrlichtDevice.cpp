...
IrrlichtNetCore::Randomizer^ IrrlichtDevice::CreateRandomizer()
{
    irr::IRandomizer* r = m_IrrlichtDevice->createDefaultRandomizer();
    return IrrlichtNetCore::Randomizer::Wrap(r);
}
...
bool IrrlichtDevice::PostEvent(IrrlichtNetCore::Event^ e)
{
...
IrrlichtNetCore::Logger^ IrrlichtDevice::Logger::get()
{
    irr::ILogger* l = m_IrrlichtDevice->getLogger();
    return IrrlichtNetCore::Logger::Wrap(l);
}

IrrlichtNetCore::OSOperator^ IrrlichtDevice::OSOperator::get()
{
    irr::IOSOperator* o = m_IrrlichtDevice->getOSOperator();
    return IrrlichtNetCore::OSOperator::Wrap(o);
}

IrrlichtNetCore::Randomizer^ IrrlichtDevice::Randomizer::get()
{
    irr::IRandomizer* r = m_IrrlichtDevice->getRandomizer();
    return IrrlichtNetCore::Randomizer::Wrap(r);
}

void IrrlichtDevice::Randomizer::set(IrrlichtNetCore::Randomizer^ value)
{
...
IrrlichtNetCore::Timer^ IrrlichtDevice::Timer::get()
{
    irr::ITimer* t = m_IrrlichtDevice->getTimer();
    return IrrlichtNetCore::Timer::Wrap(t);
}
...
bool IrrlichtDevice::Event(IrrlichtNetCore::Event^ e)
{
    return OnEvent(e);
}
