...
IrrlichtNetCore::IO::FileSystem^ GUIEnvironment::FileSystem::get()
{
    io::IFileSystem* f = m_GUIEnvironment->getFileSystem();
    return IrrlichtNetCore::IO::FileSystem::Wrap(f);
}
...
IrrlichtNetCore::OSOperator^ GUIEnvironment::OSOperator::get()
{
