...
Event::Event(IrrlichtNetCore::GUI::GUIEventType type, IrrlichtNetCore::GUI::GUIElement^ caller, IrrlichtNetCore::GUI::GUIElement^ element)
    : Lime::NativeValue<SEvent>(true)
{
...
Event::Event(IrrlichtNetCore::GUI::GUIEventType type, IrrlichtNetCore::GUI::GUIElement^ caller)
    : Lime::NativeValue<SEvent>(true)
{
    m_NativeValue = new SEvent();
    m_NativeValue->EventType = EET_GUI_EVENT;
