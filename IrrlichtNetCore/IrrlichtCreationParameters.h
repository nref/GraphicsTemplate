...
public:
    ...
    property IrrlichtNetCore::DeviceType DeviceType
    {
        IrrlichtNetCore::DeviceType get() { return (IrrlichtNetCore::DeviceType)m_NativeValue->DeviceType; }
        void set(IrrlichtNetCore::DeviceType value) { m_NativeValue->DeviceType = (E_DEVICE_TYPE)value; }
    }
