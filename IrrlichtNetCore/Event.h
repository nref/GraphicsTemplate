...
public:
    ...
    public:
        ...
        /// </summary>
        IrrlichtNetCore::GUI::GUIElement^ Caller;

        /// <summary>
        /// If the event has something to do with another element, it will be held here.
        /// </summary>
        IrrlichtNetCore::GUI::GUIElement^ Element;

        /// <summary>
        /// Type of GUI event.
        /// </summary>
        IrrlichtNetCore::GUI::GUIEventType Type;

    internal:

        GUIEvent(const SEvent::SGUIEvent& v)
            : Caller(IrrlichtNetCore::GUI::GUIElement::Wrap(v.Caller))
            , Element(IrrlichtNetCore::GUI::GUIElement::Wrap(v.Element))
            , Type((IrrlichtNetCore::GUI::GUIEventType)v.EventType) {}
    };
    ...
    /// </summary>
    Event(IrrlichtNetCore::GUI::GUIEventType type, IrrlichtNetCore::GUI::GUIElement^ caller, IrrlichtNetCore::GUI::GUIElement^ element);

    /// <summary>
    /// Constructs a GUI event.
    /// </summary>
    Event(IrrlichtNetCore::GUI::GUIEventType type, IrrlichtNetCore::GUI::GUIElement^ caller);
